...
#   SIGN_IDENTITY         (default: Developer ID Application: Elimelech Oshinsky (GY6L5GL2Z7))
...
SIGN_IDENTITY="${SIGN_IDENTITY:-Developer ID Application: Elimelech Oshinsky (GY6L5GL2Z7)}"
