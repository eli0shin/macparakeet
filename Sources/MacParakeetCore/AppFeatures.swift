...
public enum AppFeatures {
    ...
    /// Confirmed actionable states (recovering, system-source stalls,
    /// interrupted, and unavailable) bypass this flag. The microphone has no
    /// stalled source-health state; silence and mute remain hidden.
