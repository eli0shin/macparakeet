...
final class MockTransformLLMService: LLMServiceProtocol, @unchecked Sendable {
    ...
    func chat(question: String, transcript: String, userNotes: String?, history: [ChatMessage])
        async throws -> String
    { "" }
    func transform(text: String, prompt: String) async throws -> String { "" }
    func formatTranscript(transcript: String, promptTemplate: String, source: FormatterSource, defaultPromptUsed: Bool)
        async throws -> String
    { "" }
    func formatTranscriptDetailed(
        transcript: String, promptTemplate: String, source: FormatterSource, defaultPromptUsed: Bool
